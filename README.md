...
│   │   ├── EngineProcessManager.java # makeExecutable chmod helper (v1.2.0 Phase 73 NEW; v1.2.1 slimmed to 102 lines)
...
│   │   ├── EngineHealthMonitor.java  # Engine response-time + recovery-count state holder (v1.2.0 Phase 73 NEW; v1.2.1 slimmed to 73 lines)
...
- **Documentation**: BUILDING.md, PRIVACY.md, README.md directory tree, NOTICE, all 7 README.license files, and Chinese/English HTML manuals updated to reflect v1.2.1 changes.
